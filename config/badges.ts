/**
 * Configuration Badges - Tables Magiques
 * ISO/IEC 25010 - Donnees statiques badges
 *
 * NOTE: Ce fichier contient les DONNEES de configuration
 * Les TYPES sont dans @/types/badge (principe SRP)
 */

import type { BadgeDefinition } from '@/types/badge';

// =============================================================================
// BADGES MODE PRACTICE (8 badges)
// =============================================================================
...
// =============================================================================
// BADGES MODE CHALLENGE (5 badges)
// =============================================================================
